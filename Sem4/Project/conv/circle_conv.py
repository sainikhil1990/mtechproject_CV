...
def draw_conveyor_belt_with_boxes( moving_circle_position, save_path):
...
for i in moving_box_positions:
    ...
    save_path = f"image_file/circle/circle_{i}.png"
    moving_circle_position = (i,2.5)
    draw_conveyor_belt_with_boxes(moving_circle_position, save_path)
